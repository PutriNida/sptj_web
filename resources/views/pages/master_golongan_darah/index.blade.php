         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between flex-wrap">
               <div class="header-title">
                ...
                <div class="">
                    <a href="{{ url('/master_golongan_darah/create') }}" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                        <i class="btn-inner">
                     ...
                     <tbody>
                        @forelse ($goldarah as $gol)
                            <tr>
                                ...
                                <td>{{ $gol->gol_darah }}</td>
                                @if($gol->status_enabled == '1') <td>Aktif</td>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">        
                                        <form action="{{ route('gol_darah.destroy', $gol->kd_gol_darah) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" href="{{ route('gol_darah.edit', $gol->kd_gol_darah) }}">
                        ...
                        <div class="alert alert-danger alert-dismissible d-flex align-items-center" role="alert">
                            ...
                            <div>
                                Data Golongan Darah Belum Tersedia!
                            </div>
                            <a type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" href="{{ Session::forget('error'); }}"></a>
                        </div>
                        @endforelse
