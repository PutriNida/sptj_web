                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Tambah Kategori Informasi</h4>
                        </div>
                    </div>
                    <div class="card-body">
                            <form action="{{ route('kategori_informasi.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" class="form-control" id="kategoriinformasi" name="kategori_informasi"  autocomplete="off" required>
                                    </div>
                                </div>
