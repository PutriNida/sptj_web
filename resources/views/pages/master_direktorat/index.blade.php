                 ...
                 <table id="datatable" class="table table-striped" data-toggle="data-table">
                     ...
                     <tbody>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <form action="{{ route('direktorat.destroy', $stts->kd_direktorat) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" href="{{ route('direktorat.edit', $stts->kd_direktorat) }}">
                        ...
                        <div class="alert alert-danger alert-dismissible d-flex align-items-center" role="alert">
                            ...
                            <div>
                                Data Status direktorat Belum Tersedia!
                            </div>
                            <a type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" href="{{ Session::forget('error'); }}"></a>
                        </div>
                        @endforelse
