              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <h6 class="mb-0 text-sm">{{ $lok->direktorat }}</h6>
                                    </div>
                                </td>
                                ...
                                @endif
                                <td class="align-middle text-center text-sm">   
                                    <form action="{{ route('direktorat.destroy', $lok->kd_direktorat) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <a class="btn btn-warning btn-sm" href="{{ route('direktorat.edit', $lok->kd_direktorat) }}">
                                            Edit
                                        </a>
                                        <input type="hidden" name="kd_direktorat" value="{{ $lok->kd_direktorat }}"/>
                        ...
                        @empty
                         <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <span class="alert-text"><strong>Maaf!</strong> Data Direktorat Belum Tersedia!!</span>
                            <a href="{{ Session::forget('error'); }}" type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </a>
                        </div>
