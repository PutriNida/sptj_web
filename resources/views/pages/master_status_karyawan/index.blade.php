          ...
          <div class="card mb-4">
            <div class="card-header pb-0">              
              <div class="d-flex align-items-center">
                <h6 class="mb-0">Status Karyawan</h6>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>                     
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Status Karyawan</th>
                  ...
                  <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <h6 class="mb-0 text-sm">{{ $stts->status_karyawan }}</h6>
                                    </div>
                                </td>
                                ...
                                <td class="align-middle text-center text-sm">   
                                    <form action="{{ route('status_karyawan.destroy', $stts->kd_status_karyawan) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <a class="btn btn-warning btn-sm" href="{{ route('status_karyawan.edit', $stts->kd_status_karyawan) }}">
                                            Edit
                                        </a>
                        ...
                        @empty
                         <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <span class="alert-text"><strong>Maaf!</strong> Data Status Karyawan Belum Tersedia!!</span>
                            <a href="{{ Session::forget('error'); }}" type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </a>
                        </div>
