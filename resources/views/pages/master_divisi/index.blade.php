         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between flex-wrap">
               <div class="header-title">
                ...
                <div class="">
                    <a href="{{ url('/master_divisi/create') }}" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                        <i class="btn-inner">
                     ...
                     <tbody>
                        @forelse ($divisi as $div)
                            <tr>
                                ...
                                <td>{{ $div->direktorat }}</td>
                                <td>{{ $div->divisi }}</td>
                                @if($div->status_enabled == '1') <td>Aktif</td>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <form action="{{ route('divisi.destroy', $div->kd_divisi) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" href="{{ route('divisi.edit', $div->kd_divisi) }}">
