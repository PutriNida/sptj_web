        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Karti Identitas</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('kartu_identitas.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="kartu_identitas">Karti Identitas:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="kartu_identitas" name="kartu_identitas"  autocomplete="off" required>
                            </div>
                        </div>
