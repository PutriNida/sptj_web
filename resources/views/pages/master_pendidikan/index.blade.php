         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between flex-wrap">
               <div class="header-title">
                ...
                <div class="">
                    <a href="{{ url('/master_pendidikan/create') }}" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                        <i class="btn-inner">
                     ...
                     <tbody>
                        @forelse ($pendidikan as $pend)
                            <tr>
                                ...
                                @if($pend->status_enabled == '1') <td>Aktif</td>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">        
                                        <form action="{{ route('pendidikan.destroy', $pend->kd_pendidikan) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" href="{{ route('pendidikan.edit', $pend->kd_pendidikan) }}">
