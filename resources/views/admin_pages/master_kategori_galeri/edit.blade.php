        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Kategori Galeri</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('kategori_galeri.update', $kategorigaleri->kd_kategori_galeri) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="kategori_galeri">Kategori Galeri:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="kategori_galeri" name="kategori_galeri"  autocomplete="off" value="{{ $kategorigaleri->kategori_galeri }}" required>
                            </div>
                        </div>
