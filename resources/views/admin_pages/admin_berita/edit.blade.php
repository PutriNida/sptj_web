    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin_berita.update') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ url('/admin_berita') }}" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
