...
<div class="container-fluid py-4">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Edit Jenis Dokumen</h6>
            <a href="{{ route('jenis_dokumen.index') }}" class="btn btn-secondary btn-sm">Kembali</a>
        </div>

        <div class="card-body">
            <form action="{{ route('jenis_dokumen.update') }}" method="POST" class="form-horizontal">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nama_jenis_dokumen" name="nama_jenis_dokumen" value="{{ old('nama_jenis_dokumen', $item->nama_jenis_dokumen) }}" required>
