...
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12">
<form action="{{ route('member.update') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                {{ csrf_field() }}
                <input type="hidden" name="no_karyawan" value="{{ $member->no_karyawan }}">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" id="datadiri" style="display: block">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="no_karyawan" name="no_karyawan"  autocomplete="off" required value="{{ $member->no_karyawan }}" disabled>
                            </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" id="datakontak" style="display: none">
                        @forelse ($detailkontak as $dk)
                          <div class="form-group row">
                            <div class="col-sm-3">
                            <select class="form-select" id="exampleFormControlSelect1" name="kd_tipe_kontak[]">
                            @if(isset($tipekontak))
                            @forelse ($tipekontak as $tipe)
                            <option value="{{ $tipe->kd_tipe_kontak }}" 
                            {{ $tipe->kd_tipe_kontak == $dk->kd_tipe_kontak ? 'selected' : '' }}>{{ $tipe->tipe_kontak }}</option>
                            @empty
                            @endforelse
                            @endif
                            </select>
                            ...
                            <div class="col-sm-6">
                            <input type="text" class="form-control" id="tujuan" name="tujuan[]" autocomplete="off" value="{{ $dk->kontak }}">
                            </div>
                            @if($loop->iteration > 1)
                            <div class="col-sm-3"><button type="button" name="remove" id="" class="btn btn-danger remove">Hapus</button></div>
                            @else
                            <div class="col-sm-3"><button type="button" name="add" id="add" class="btn btn-success">Tambah</button></div>
                            @endif
                            </div>
                        @empty
                        @endforelse
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" id="datapendidikan" style="display: none">
                        @forelse ($detailpend as $dp)
                          <div class="form-group row">
                            <div class="col-sm-3">
                            <select class="form-select" id="exampleFormControlSelect1" name="kd_pendidikan[]">
                            @if(isset($pendidikan))
                            @forelse ($pendidikan as $pend)
                            <option value="{{ $pend->kd_pendidikan }}" 
                            {{ $pend->kd_pendidikan == $dp->kd_pendidikan ? 'selected' : '' }}>{{ $pend->pendidikan }}</option>
                            @empty
                            @endforelse
                            @endif
                            </select>
                            ...
                            <div class="col-sm-3">
                            <input type="text" class="form-control" id="institusi" name="nama_institusi[]" placeholder="Nama Institusi" autocomplete="off" value="{{ $dp->nama_institusi}}">
                            </div>
                            <div class="col-sm-3">
                            <input type="text" class="form-control" id="jurusan" name="jurusan[]" placeholder="Jurusan" autocomplete="off"  value="{{ $dp->jurusan}}">
                            </div>
                            <div class="col-sm-3"></div>
                            <div class="col-sm-3"></div>
                            <div class="col-sm-3">
                            <input type="number" class="form-control" id="thn_masuk" name="thn_masuk[]" placeholder="Tahun Masuk" autocomplete="off"  value="{{ $dp->thn_masuk}}">
                            </div>
                            <div class="col-sm-3">
                            <input type="number" class="form-control" id="thn_keluar" name="thn_keluar[]" placeholder="Tahun Keluar" autocomplete="off"  value="{{ $dp->thn_lulus}}">
                            </div>
                            @if($loop->iteration > 1)
                            <div class="col-sm-3"><button type="button" name="removepend" id="" class="btn btn-danger remove">Hapus</button></div>
                            @else
                            <div class="col-sm-3"><button type="button" name="addpend" id="addpend" class="btn btn-success">Tambah</button></div>
                            @endif
                            </div>
                        @empty
                        @endforelse
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" id="datakeluarga" style="display: none">
                        ...
                        <div class="form-group row">
                            ...
                            <option value="{{ $hub->kd_hub_keluarga }}"
                            {{ $hub->kd_hub_keluarga == $kel->kd_hub_keluarga ? 'selected' : '' }}>{{ $hub->hub_keluarga }}</option>
                            @empty
                            @endforelse
                            @endif
                            </select>
                            ...
                            <div class="col-sm-6">
                            <input type="text" class="form-control" id="nama_lengkap_kel" name="nama_lengkap_kel[]" placeholder="Nama Lengkap" autocomplete="off" value="{{ $kel->nama_lengkap }}">
                            </div>
                            @if($loop->iteration > 1)
                            <div class="col-sm-3"><button type="button" name="removekel" id="" class="btn btn-danger remove">Hapus</button></div>
                            @else
                            <div class="col-sm-3"><button type="button" name="addkel" id="addkel" class="btn btn-success">Tambah</button></div>
                            @endif
                            </div>
                        @empty
                        @endforelse
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body" id="datamedsos" style="display: none">
                        @forelse ($detailmedsos as $mds)
                        <div class="form-group row">
                            <div class="col-sm-3">
                            <select class="form-select" id="exampleFormControlSelect1" name="kd_media_sosial[]">
                            @if(isset($mediasosial))
                            @forelse ($mediasosial as $ms)
                            <option value="{{ $ms->kd_media_sosial }}" 
                            {{ $ms->kd_media_sosial == $mds->kd_media_sosial ? 'selected' : '' }}>{{ $ms->media_sosial }}</option>
                            @empty
                            @endforelse
                            @endif
                            </select>
                            ...
                            <div class="col-sm-6">
                            <input type="text" class="form-control" id="username" name="username[]" placeholder="Username" autocomplete="off" value="{{ $mds->username }}">
                            </div>
                            @if($loop->iteration > 1)
                            <div class="col-sm-3"><button type="button" name="removemedsos" id="" class="btn btn-danger remove">Hapus</button></div>
                            @else
                            <div class="col-sm-3"><button type="button" name="addmedsos" id="addmedsos" class="btn btn-success">Tambah</button></div>
                            @endif
                            </div>
                        @empty
                        @endforelse
...
var detailpendidikan = <?php echo json_encode($detailpend) ?>;
var detailkeluarga = <?php echo json_encode($detailkel) ?>;
var detailmedsos = <?php echo json_encode($detailmedsos) ?>;

var countKontak = detailkontak.length;
var countPendidikan = detailpendidikan.length;
var countKeluarga = detailkeluarga.length;
var countMedsos = detailmedsos.length;
